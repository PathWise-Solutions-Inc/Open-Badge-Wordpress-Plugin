        ...
        registerBlockType('pbc/badges-block', {
            ...
            edit({ attributes, setAttributes }) {
                ...
                return (
                    <>
                        <InspectorControls>
                            <PanelBody title={__('Display Settings', 'pbc')}>
                                <SelectControl
                                    label={__('Layout', 'pbc')}
                                    value={layout}
                                    options={[
                        ...
                        {layout === 'grid' && (
                            <div className={`pbc-badges-block grid`} style={{ '--columns': columns }}>
                                {badges && badges.length > 0 ? (
                                    ...
                                    <p>{__('No badges available.', 'pbc')}</p>
                                )}
                            </div>
                        )}
                        {layout === 'table' && (
                            <table className="pbc-badges-block table" style={{'--columns': columns}}>
                                ...
                                {badges && badges.length > 0 ? (
                                    ...
                                    <tr>
                                        <td>{__('No badges available.', 'pbc')}</td>
                                    </tr>
                                )}
                                </tbody>
                            </table>
                        ...
                        {layout === 'list' && (
                            <ul className="pbc-badges-block list">
                                {badges && badges.length > 0 ? (
                                    ...
                                    <li>{__('No badges available.', 'pbc')}</li>
                                )}
                            </ul>
                        )}
                    </>
